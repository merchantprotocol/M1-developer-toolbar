 ...
 */
class MP_Debug_Helper_Data extends Mage_Core_Helper_Data
{
    const DEBUG_OPTIONS_ENABLE_PATH = 'mp_debug/options/enable';
    const DEBUG_OPTION_PERSIST_PATH = 'mp_debug/options/persist';
    const DEBUG_OPTION_PERSIST_EXPIRATION_PATH = 'mp_debug/options/persist_expiration';
    const DEBUG_OPTION_FORCE_VARIEN_PROFILE_PATH = 'mp_debug/options/force_varien_profile';
    const DEBUG_OPTION_USE_STORE_LOCALE = 'mp_debug/options/use_store_locale';
    const DEBUG_OPTION_CAPTURE_SQL_STACKTRACE = 'mp_debug/options/capture_sql_stacktrace';
    const DEBUG_OPTION_STRIP_ZEND_DB_TRACES = 'mp_debug/options/strip_zend_db_traces';
    const DEBUG_OPTION_TRIM_MAGENTO_DIR = 'mp_debug/options/trim_magento_basedir';
    ...
    /**
     * Returns module name (e.g MP_Debug)
     *
     * @return string
     */
    ...
    {
        return !$this->isMPDebugRequest($this->_getRequest()) && $this->canShowToolbar();
    }
     ...
     * @return bool
     */
    public function isMPDebugRequest(Mage_Core_Controller_Request_Http $request)
    {
        return strpos($request->getPathInfo(), '/mp_debug/') === 0;
    }
     ...
     * @see MP_Debug_Model_Model
     *
     * @param MP_Debug_Model_Model|MP_Debug_Model_Collection $a
     * @param MP_Debug_Model_Model|MP_Debug_Model_Collection $b
     * @return int
     */
    ...
    {
        usort($objects, array('MP_Debug_Helper_Data', 'sortModelCmp'));
    }
